...
function enrichCandidates(candidates = [], context = {}) {
  ...
  return {
    ...
    diagnostics: {
      ...
      historicalInfluenceEnabled: confidenceResult.diagnostics.historicalInfluenceEnabled === true,
      historicalInfluenceMode: confidenceResult.diagnostics.historicalInfluenceMode || 'disabled',
      historicalInfluenceAppliedCount: confidenceResult.diagnostics.historicalInfluenceAppliedCount || 0,
      historicalBoostedCount: confidenceResult.diagnostics.historicalBoostedCount || 0,
      historicalPenalizedCount: confidenceResult.diagnostics.historicalPenalizedCount || 0,
      historicalInfluenceWarnings: confidenceResult.diagnostics.historicalInfluenceWarnings || [],
